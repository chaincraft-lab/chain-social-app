<template>
  <nav class="bg-white shadow-sm">
    <div class="container mx-auto">
      <!-- Top Bar -->
      <div class="flex items-center justify-between py-3 border-b border-light-200">
        <!-- Logo -->
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="relative hidden md:block">
            <input 
              ...
              class="w-64 py-2 pl-10 pr-4 text-sm bg-light-100 border-none rounded-full focus:outline-none focus:ring-2 focus:ring-primary/50"
            />
            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-dark/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button 
            ...
            class="p-2 text-dark md:hidden focus:outline-none"
          >
          ...
          <div class="hidden md:flex items-center space-x-3">
            <a href="#" class="text-dark/70 hover:text-primary">
      ...
      <div class="relative">
        ...
        <div class="hidden md:flex items-center justify-between py-3">
          ...
          <div class="flex items-center">
            <span class="text-sm font-medium text-dark/70">{{ currentDate }}</span>
          </div>
        </div>
        ...
        <div 
          ...
          class="md:hidden bg-white border-t border-light-200 py-4 slide-in-up"
        >
          <!-- Mobile Search -->
          <div class="relative px-4 mb-4">
            <input 
              type="text" 
              placeholder="Haber ara..." 
              class="w-full py-2 pl-10 pr-4 text-sm bg-light-100 border-none rounded-full focus:outline-none focus:ring-2 focus:ring-primary/50"
            />
          ...
          <!-- Mobile Social -->
          <div class="flex items-center space-x-4 px-4 mt-4 pt-4 border-t border-light-200">
            <a href="#" class="text-dark/70 hover:text-primary">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
              </svg>
