  ...
  <footer class="bg-dark text-white">
    <div class="container mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-12">
        ...
        <!-- Newsletter -->
        <div>
          <h3 class="text-xl font-semibold mb-4">Bülten</h3>
          <p class="text-light-200 mb-4">
          ...
          <form @submit.prevent="subscribeNewsletter" class="mt-4">
            <div class="flex">
              <input 
                ...
                class="w-full px-4 py-2 text-dark rounded-l-md focus:outline-none"
                required
              />
              <button 
                type="submit" 
      ...
      <!-- Bottom Footer -->
      <div class="py-4 border-t border-dark-700 text-center text-light-300 text-sm">
